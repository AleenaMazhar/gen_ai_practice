...
def get_rating(product_id:int) -> str:
    """
    Get the average rating for a product by its ID.
    Returns a JSON object with: product_id, average_rating, number_of_reviews.
    """
...
def checkout(product_id : int) -> str:
    ...
    return (
        f"Order placed successfully! Order ID: {order_id}, Product: {name}, Price: ${price:.2f}"
    )
...
def describe_product_image(image_path: str) -> str:
    ...
    Use this when the user uploades a photo of a product they are interested in.
    The returned attributes can be used directly with search products.
    """
...
if __name__ == "__main__":
    ...
    #                 "role": "user",
    #                 "content": (
    #                     "I want to by organic honey with 4.5+ rating and less than $20 price."
